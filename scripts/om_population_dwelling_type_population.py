'''
ONE MAP POPULATION DWELLING TYPE POPULATION
...
def main():
    ...
    print("API Retrieves data related to dwelling type population for given planning area name and year.")
    
    # run authorisation_string function
    authorisation_string = return_authorisation_string()

    # initialised url variable:
    base_url = "https://www.onemap.gov.sg/api/public/popapi/getTypeOfDwellingPop" # ?planningArea=Bedok&year=2020  
    ...
    try:
        ...
        export_filepath = "../assets/onemap/population_dwelling_type_population"
