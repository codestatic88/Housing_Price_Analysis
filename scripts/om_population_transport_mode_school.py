'''
ONE MAP POPULATION TRANSPORT MODE TO SCHOOL
...
This API data related to mode of transport to school for given planning area name and year.
...
def main():
    ...
    print("API Retrieves data related to mode of transport to school for given planning area name and year.")
    
    # run authorisation_string function
    authorisation_string = return_authorisation_string()

    # initialised url variable:
    base_url = "https://www.onemap.gov.sg/api/public/popapi/getModeOfTransportSchool" # ?planningArea=Bedok&year=2020  
    ...
    try:
        ...
        export_filepath = "../assets/onemap/population_transport_mode_school"
